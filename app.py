...
# --- UNIQUE FUTURISTIC MARCO AI SVG LOGO ---
...
# --- STRICT MIRRORING SYSTEM PROMPT ---
SYSTEM_PROMPT = """
...
# --- SIDEBAR UI WITH CLEAN HTML HEADER ---
sidebar_header = f'''
...
# --- UNIQUE ENTRANCE SCREEN (IF NO MESSAGES) ---
if not st.session_state["messages"]:
    ...
    <div style="display: flex; flex-direction: column; align-items: center; justify-content: center; height: 50vh; text-align: center;">
        {large_logo}
        <div style="font-size: 34px; font-weight: 700; color: #1a202c; margin-top: 20px; font-family: 'Segoe UI', sans-serif;">
...
if user_input:
    # Handle text or file upload object
